    ...
    <main className="bg-gradient-to-b from-gray-50 to-gray-100 min-h-screen py-10">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
          {/* Profile Header */}
          <div className="bg-gradient-to-r from-teal-500/10 to-emerald-500/10 p-6 border-b border-gray-200">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              <div className="bg-gradient-to-r from-teal-600 to-emerald-600 w-24 h-24 rounded-full flex items-center justify-center text-white text-3xl font-bold">
          ...
          <div className="p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <Link href="/protected/profile/edit">
                <button className="bg-teal-600 hover:bg-teal-700 text-white font-medium py-2 px-4 rounded-md transition-all duration-200 shadow-sm hover:shadow-md">
                  Edit Profile
                </button>
              </Link>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-gray-800">{userProfile.first_name}</p>
              </div>
              
              <div>
                <h4 className="text-sm font-medium text-gray-500 mb-1">Last Name</h4>
                <p className="text-gray-800">{userProfile.last_name}</p>
              </div>
              
              <div>
                <h4 className="text-sm font-medium text-gray-500 mb-1">Student Number</h4>
                <p className="text-gray-800">{userProfile.student_number}</p>
              </div>
              
              <div>
                <h4 className="text-sm font-medium text-gray-500 mb-1">Program</h4>
                <p className="text-gray-800">{program?.program_name || "Not specified"}</p>
              </div>
              
              <div>
                <h4 className="text-sm font-medium text-gray-500 mb-1">Target Average</h4>
                <p className="text-gray-800">{userProfile.target_average || "Not set"}</p>
              </div>
            ...
            <div className="mt-8 border-t border-gray-200 pt-6">
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/protected/reset-password">
                  <button className="bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium py-2 px-4 rounded-md transition-all duration-200 shadow-sm hover:shadow-md">
                    Change Password
                  </button>
                </Link>
              </div>
