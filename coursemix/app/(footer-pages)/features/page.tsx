  ...
  return (
    <div className="space-y-10">
      <div className="space-y-4">
        <h1 className="text-3xl font-bold text-gray-900">CourseMix Features</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Personalized Course Planning</h2>
        ...
        <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
          <div className="text-3xl mb-4">🔧</div>
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Dynamic Course Adjustment</h2>
          <p className="text-gray-600">
        ...
        <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
          <div className="text-3xl mb-4">📊</div>
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Course Insights</h2>
          <p className="text-gray-600">
        ...
        <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
          <div className="text-3xl mb-4">💬</div>
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Community Feedback</h2>
          <p className="text-gray-600">
      ...
      <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="font-medium text-gray-800">Degree Progress Tracking</h3>
              <p className="text-sm text-gray-600">Monitor your academic progress toward graduation in real-time.</p>
            </div>
          </div>
          <div className="flex items-start">
            <svg className="h-5 w-5 text-teal-500 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
              <h3 className="font-medium text-gray-800">Grades Calculator</h3>
              <p className="text-sm text-gray-600">See your real time overall average and individual course grades.</p>
            </div>
          </div>
          <div className="flex items-start">
            <svg className="h-5 w-5 text-teal-500 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
              <h3 className="font-medium text-gray-800">Term Progress Bar</h3>
              <p className="text-sm text-gray-600">Easily see how far you are into the term and how many days are left.</p>
            </div>
          </div>
          <div className="flex items-start">
            <svg className="h-5 w-5 text-teal-500 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
              <h3 className="font-medium text-gray-800">Mobile Compatibility</h3>
              <p className="text-sm text-gray-600">Access CourseMix on any device with our responsive design.</p>
            </div>
          </div>
          <div className="flex items-start">
            <svg className="h-5 w-5 text-teal-500 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
              <h3 className="font-medium text-gray-800">Reading Week Tracker</h3>
              <p className="text-sm text-gray-600">See how far away you are from the next reading week in your dashboard.</p>
            </div>
          </div>
          <div className="flex items-start">
            <svg className="h-5 w-5 text-teal-500 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Your academic information is protected with enterprise-grade security.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="text-center space-y-4">
        <h2 className="text-2xl font-semibold text-gray-800">Ready to Optimize Your Academic Journey?</h2>
        <p className="text-gray-600">Join thousands of Brock University students who are already using CourseMix.</p>
